 ...
 *         - sell_price
 */
export const CreateTankTypeRequestSchema = z
  .object({
    name: z
      .string()
    ...
    weight: z
      ...
      .max(5, "Peso debe tener máximo 5 caracteres"),
    ...
    scale: z
      .string()
      .max(10, "Escala debe tener máximo 10 caracteres")
      .optional(),
  })
 ...
 */
export const UpdateTankTypeRequestSchema = z
  .object({
    name: z
      .string()
      .min(1, "Nombre es requerido")
 ...
 *           description: Number of results to skip (defaults to 0)
 */
export const InventoryItemFiltersRequestSchema = z
  .object({
...
export type TankTypeFiltersRequest = z.infer<
  typeof TankTypeFiltersRequestSchema
>;
export type InventoryItemFiltersRequest = z.infer<
  typeof InventoryItemFiltersRequestSchema
>;
